...
/**
 * This class stands for DatosRemitenteRequest StructType
 */
#[AllowDynamicProperties]
class DatosRemitenteRequest extends AbstractStructBase
{
    /**
     * The Direccion
    ...
    /**
     * Constructor method for DatosRemitenteRequest
     *
     * @uses DatosRemitenteRequest::setDireccion()
     * @uses DatosRemitenteRequest::setNif()
     * @uses DatosRemitenteRequest::setNombre()
     * @uses DatosRemitenteRequest::setTelefono()
     * @uses DatosRemitenteRequest::setContacto()
     * @uses DatosRemitenteRequest::setHorario()
     * @uses DatosRemitenteRequest::setObservaciones()
     */
    public function __construct(?DireccionRequest $direccion = null, ?string $nif = null, ?string $nombre = null, ?string $telefono = null, ?string $contacto = null, ?HorarioRequest $horario = null, ?string $observaciones = null)
    {
        $this
     ...
     * Set Direccion value
     *
     * @return \StructType\DatosRemitenteRequest
     */
