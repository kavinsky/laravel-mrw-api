...
/**
 * This class stands for TransmitirEnvioRequest StructType
 */
...
class TransmitirEnvioRequest extends BaseRequest
{
    ...
    /**
     * Constructor method for TransmitirEnvioRequest
     *
     * @uses TransmitirEnvioRequest::setFecha()
     * @uses TransmitirEnvioRequest::setNombre()
     * @uses TransmitirEnvioRequest::setVerificacionDireccion()
     * @uses TransmitirEnvioRequest::setVia()
     * @uses TransmitirEnvioRequest::setDireccion()
     * @uses TransmitirEnvioRequest::setNumeroDireccion()
     * @uses TransmitirEnvioRequest::setRestoDireccion()
     * @uses TransmitirEnvioRequest::setCodigoPostal()
     * @uses TransmitirEnvioRequest::setPoblacion()
     * @uses TransmitirEnvioRequest::setEnFranquicia()
     * @uses TransmitirEnvioRequest::setSMSRecogida()
     * @uses TransmitirEnvioRequest::setSMSEntrega()
     * @uses TransmitirEnvioRequest::setReferencia()
     * @uses TransmitirEnvioRequest::setCorrelacionRef()
     * @uses TransmitirEnvioRequest::setServicio()
     * @uses TransmitirEnvioRequest::setBultos()
     * @uses TransmitirEnvioRequest::setKilos()
     * @uses TransmitirEnvioRequest::setPuentes()
     * @uses TransmitirEnvioRequest::setNif()
     * @uses TransmitirEnvioRequest::setReembolso()
     * @uses TransmitirEnvioRequest::setComisionReembolso()
     * @uses TransmitirEnvioRequest::setImporteReembolso()
     * @uses TransmitirEnvioRequest::setMercancia()
     * @uses TransmitirEnvioRequest::setValorDeclarado()
     * @uses TransmitirEnvioRequest::setAtencionDe()
     * @uses TransmitirEnvioRequest::setTelefono()
     * @uses TransmitirEnvioRequest::setObservaciones()
     * @uses TransmitirEnvioRequest::setEntregaPartirDe()
     * @uses TransmitirEnvioRequest::setConfirmacionInmediata()
     * @uses TransmitirEnvioRequest::setRetorno()
     * @uses TransmitirEnvioRequest::setGestion()
     * @uses TransmitirEnvioRequest::setEntregaSabado()
     * @uses TransmitirEnvioRequest::setEntrega830()
     * @uses TransmitirEnvioRequest::setCodigoPromocion()
     * @uses TransmitirEnvioRequest::setNumeroSobre()
     * @uses TransmitirEnvioRequest::setFrecuencia()
     * @uses TransmitirEnvioRequest::setTipoNotificacion()
     * @uses TransmitirEnvioRequest::setNotificacion1()
     * @uses TransmitirEnvioRequest::setNotificacion2()
     * @uses TransmitirEnvioRequest::setMailSMS1()
     * @uses TransmitirEnvioRequest::setMailSMS2()
     * @uses TransmitirEnvioRequest::setTramoHorario()
     * @uses TransmitirEnvioRequest::setPortesDebidos()
     * @uses TransmitirEnvioRequest::setMascara_Tipos()
     * @uses TransmitirEnvioRequest::setMascara_Campos()
     * @uses TransmitirEnvioRequest::setAsistente()
     */
    public function __construct(?string $fecha = null, ?string $nombre = null, ?string $verificacionDireccion = null, ?string $via = null, ?string $direccion = null, ?string $numeroDireccion = null, ?string $restoDireccion = null, ?string $codigoPostal = null, ?string $poblacion = null, ?string $enFranquicia = null, ?string $sMSRecogida = null, ?string $sMSEntrega = null, ?string $referencia = null, ?string $correlacionRef = null, ?string $servicio = null, ?string $bultos = null, ?string $kilos = null, ?string $puentes = null, ?string $nif = null, ?string $reembolso = null, ?string $comisionReembolso = null, ?string $importeReembolso = null, ?string $mercancia = null, ?string $valorDeclarado = null, ?string $atencionDe = null, ?string $telefono = null, ?string $observaciones = null, ?string $entregaPartirDe = null, ?string $confirmacionInmediata = null, ?string $retorno = null, ?string $gestion = null, ?string $entregaSabado = null, ?string $entrega830 = null, ?string $codigoPromocion = null, ?string $numeroSobre = null, ?string $frecuencia = null, ?string $tipoNotificacion = null, ?string $notificacion1 = null, ?string $notificacion2 = null, ?string $mailSMS1 = null, ?string $mailSMS2 = null, ?string $tramoHorario = null, ?string $portesDebidos = null, ?string $mascara_Tipos = null, ?string $mascara_Campos = null, ?string $asistente = null)
    {
        $this
            ->setFecha($fecha)
            ->setNombre($nombre)
     ...
     * Set Fecha value
     *
     * @return \StructType\TransmitirEnvioRequest
     */
